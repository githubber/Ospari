                ...
                <tbody>
                    <tr>
                        <td style="padding:20px 0px 10px 10px;text-align:left">
                            <a href="<?php echo OSPARI_URL; ?>" style="color:#006699;text-decoration:none" target="_blank"><img height="41" width="200" src="http://www.ranksider.com/img/ranksider_logo_w200.png" alt="ranksider logo" title="ranksider logo" style="text-decoration:none; border:none"></a>
                        </td>
                    </tr>
                </tbody>
            </table>
